          ...
          {isRunning && (
            <div className="mt-3">
              ...
              <div className="w-full h-2 bg-zinc-950 rounded-full overflow-hidden border border-zinc-800">
                <div className="w-full h-full bg-gradient-to-r from-purple-600 to-emerald-500 transition-transform" style={{ transform: `scaleX(${progressPercent / 100})`, transformOrigin: 'left' }} />
              </div>
            </div>
          )}
